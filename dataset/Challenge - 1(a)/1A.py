...
if __name__ == "__main__":
    ...
    input_dir = os.path.join(script_dir, "app", "input")
    output_dir = os.path.join(script_dir, "app", "output")
    ...
    try:    
        ...
        print(f"❌ Error: Could not create directory. Please check permissions.")
        print(f"System Error: {e}")
        sys.exit(1) # Exit because the script cannot function without these dirs

    # --- Ensure input directory exists before proceeding ---
